...
public class FactoryTransacciones {
    ...
    static public ArrayList<Transaccion> filtrar_transacciones(StatusBarNotification[] notificaciones) {
        ...
        ArrayList<StatusBarNotification> list_notificaciones_original = new ArrayList<>(Arrays.asList(notificaciones));
        ...
        for (Map.Entry<String, Transaccion> entry : implementaciones.entrySet()) {
            ...
            for (StatusBarNotification notificacion : list_notificaciones) {
                ...
                try {
                    ...
                    list_notificaciones_original.remove(notificacion);
                } catch (Exception e) {

                }
            }

            list_notificaciones.clear();
            list_notificaciones.addAll(list_notificaciones_original);
        }
